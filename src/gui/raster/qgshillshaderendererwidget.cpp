...
QgsRasterRenderer *QgsHillshadeRendererWidget::renderer()
{
  ...
  renderer->SetMultiDirection( mMultiDirection->checkState() );
  return renderer;
}
...
void QgsHillshadeRendererWidget::setFromRenderer( const QgsRasterRenderer *renderer )
{
  ...
  if ( r )
  {
    ...
    mMultiDirection->setChecked( r->multiDirection() );
  }
}
...
void QgsHillshadeRendererWidget::setMultiDirection( bool isMultiDirection )
{
    mMultiDirection->setChecked( isMultiDirection );
}
...
bool QgsHillshadeRendererWidget::multiDirection() const
{
